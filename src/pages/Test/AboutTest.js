...
import SuivezMoi from "../portfolio/followMe/followMe";
import './AboutCSS.css'
import ShowBurger from "../portfolio/burger/burger";
    ...
    return (
        <div className="root">
            ...
            <Grid container alignItems="center" justifyContent="center" className="root">
                ...
                <Grid item sm={12} md={12} lg={12} xl={12} style={{textAlign: "center"}}>
                    <motion.img
                        src={moi}
                        alt="Moi"
                        className="imgBasile"
